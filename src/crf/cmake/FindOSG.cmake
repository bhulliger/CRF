...
# - Only sets OSG_DEBUG_FOUND to TRUE if all OSG libraries needed by CRF have been found
# - Looks for OSG in more places
# - Links to OpenThreads under Windows
# - Looks for the library names with the 'd' suffix (debug), if it cannot find regular libs

# Locate gdal
# This module defines
# OSG_DEBUG_LIBRARY
# OSG_DEBUG_FOUND, if false, do not try to link to gdal 
# OSG_DEBUG_INCLUDE_DIR, where to find the headers
#
...
message(STATUS "Found osgFX lib at ${OSGFX_LIBRARY}")
